        ...
        <section>
            ...
            <div id=menuGauche>
                <ul>
                    ...
                    <li>
                        <a href=#><img class="img-responsive" src="images/icones/icone_resultat.png" alt="icone resultats" width=10px> Consulter mes résultats</a>
                    </li>
                    <li>
                        <a href="uti-accueil_mes_tests.html"><img class="img-responsive" src="images/icones/icone_capteur.png" alt="icone report" width=10px> Analyse de mes tests</a>
                        <ul>
