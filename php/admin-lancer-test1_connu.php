        ...
        <section>
            ...
            <div id=menuGauche>
                <ul id=barre_nav>
                    ...
                    <li>
                        <a href=Interface_Rechercher.php><img class="img-responsive" src="../images/icones/icone_loupe.png" alt="icone loupe" width=10px> Recherche </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href=#><img class="img-responsive" src="../images/icones/icone_capteur2.png" alt="icone capteur" width=10px> Capteurs</a>
                    </li>
                    <li id="ongletfin">
