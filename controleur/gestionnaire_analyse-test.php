    ...
    <section>
        ...
        <div id=menuGauche>
            <ul id=barre_nav>
                ...
                <li id="ongletfin">
                    <a class="active" href=#><img class="img-responsive" src="../images/icones/icone_engrenage.png" alt="icone engrenage" width=10px> Analyse tests psychotechniques </a>
                </li>
        ...
        <div id=contenu>
                <div class="titre"><h1>ANALYSE GENERALE (MOYENNE)</h1></div>
